...
__export(index_exports, {
  ...
  CustomPolicyLoader: () => CustomPolicyLoader,
  Evaluator: () => Evaluator,
  JsonPolicyLoader: () => JsonPolicyLoader,
...
var PolicySchema = import_zod.z.object({
  ...
  condition: import_zod.z.record(import_zod.z.string()).optional()
});
var PolicyListSchema = import_zod.z.array(PolicySchema);
